export const BANANA_ID = 'berryclub.ek.near';
export const CHEDDAR_ID = 'token.cheddar.near';
export const CUCUMBER_ID = 'farm.berryclub.ek.near';
export const HAPI_ID = 'd9c2d319cd7e6177336b0a9c93c21cb48d84fb54.factory.bridge.near';
export const NEAR_ICON =
    'https://near.org/wp-content/themes/near-19/assets/img/brand-icon.png';
export const icons: { [tokenId: string]: string } = {
